...
const translations = {
    english: {
        ...
        home: { kicker: '~/portfolio/about', title: 'Software, games and websites.', body: 'I am Luka Ažman — a programmer working across software, web development and games, with a focus on practical and well-built digital products.', openProjects: 'Open Projects', openContact: 'Contact', factOneLabel: 'Focus', factOneValue: 'Software / Games', factTwoLabel: 'Workspace', factTwoValue: 'Code / Design / Systems', factThreeLabel: 'Current view', factThreeValue: 'Desktop' },
    ...
    slovenian: {
        ...
        home: { kicker: '~/portfolio/about', title: 'Programska oprema, igre in spletne strani.', body: 'Sem Luka Ažman — programer, ki se ukvarja z razvojem programske opreme, spletnih strani in iger, s poudarkom na praktičnih in kakovostno izdelanih digitalnih rešitvah.', openProjects: 'Odpri projekte', openContact: 'Kontakt', factOneLabel: 'Fokus', factOneValue: 'Programska oprema / igre', factTwoLabel: 'Delovno okolje', factTwoValue: 'Koda / dizajn / sistemi', factThreeLabel: 'Trenutni pogled', factThreeValue: 'Namizje' },
